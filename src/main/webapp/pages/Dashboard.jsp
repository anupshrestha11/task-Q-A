...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6"><h4><b><a href="/myQuestion">My
            Question</a></b></h4><h4><b><a href="/dashboard">Questions Pool</a></b></h4><br>
            <a href="/askQuestion">
            ...
            <table class="table ">
                ...
                <c:forEach items="${questions}" var="question" varStatus="i">
                    <tr>
                        ...
                        <td><c:out value="${question.user.userName}"></c:out></td>
